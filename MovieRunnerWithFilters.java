...
public class MovieRunnerWithFilters {
    ...
    public void printAverageRatingsByMinutes () {
        ...
        System.out.println("There are " + averageRatings.size() + " movies that are between "  + minMinutes + " and " + maxMinutes + " length with " + minNumOfRatings + " or more rating(s) :");
    }
    ...
    public void printAverageRatingsByYearAfterAndGenre () {
        ...
        System.out.println("There is(are) " + avgRatings.size() + " movie(s)  in genre of \"" + genre + "\" that was(were) directed after " + year + " with " + minNumOfRatings + " or more rating(s) :");
    }
